                    ...
                    <div className="bg-black p-6 pb-10 pt-4 rounded-t-[2rem] -mt-6 relative z-20 border-t border-white/10 shadow-[0_-10px_40px_rgba(0,0,0,0.8)]">
                        <div className="flex flex-col items-center gap-6">
                            ...
                            {!isReviewing && !isVideoReviewing && !isRecording && (
                                <button onClick={() => step === 1 ? fileInputRef.current?.click() : videoInputRef.current?.click()} className="text-white/40 text-xs font-medium hover:text-white transition-colors flex items-center gap-2 px-4 py-2 rounded-full hover:bg-white/5">Uploader</button>
                            )}
                            <AnimatePresence>
