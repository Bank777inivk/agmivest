            ...
            >
                <div>
                    ...
                    <div className="text-center">
                        ...
                        <h1 className="mt-8 text-3xl font-extrabold text-gray-900 tracking-tight">
                            {t('title')}
                        </h1>
                ...
                <div className="bg-white py-10 px-8 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] rounded-3xl border border-white relative overflow-hidden">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <motion.button
                            ...
                            type="submit"
                            disabled={isLoading}
                            className={`w-full flex justify-center items-center gap-3 py-4 px-4 bg-ely-blue text-white rounded-2xl font-bold text-lg shadow-xl shadow-ely-blue/20 hover:bg-ely-blue/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ely-blue transition-all ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
                        >
                            {isLoading ? (
