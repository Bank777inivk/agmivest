    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-6">
                                        <div className={`w-16 h-16 rounded-3xl flex items-center justify-center transition-all ${doc.file || doc.url ? 'bg-emerald-50 text-emerald-500' : 'bg-slate-50 text-slate-400'
                                            }`}>
                                            {doc.file || doc.url ? <CheckCircle className="w-8 h-8" /> : <doc.icon className="w-8 h-8 stroke-[1.5]" />}
                                        </div>
                ...
                <div className="sticky top-32 space-y-6 self-start hidden lg:block">
                    {/* Progress Card */}
