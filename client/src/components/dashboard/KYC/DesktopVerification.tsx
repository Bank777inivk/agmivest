            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-white p-8 rounded-[2.5rem] border-2 border-slate-50 shadow-sm">
                    <div className="space-y-2">
                        <p className="text-[10px] font-black text-ely-blue uppercase tracking-[0.3em]">Étape de sécurité</p>
                        <h2 className="text-3xl font-black text-slate-900 tracking-tight leading-tight">
                            Authentification de votre profil client.
                        </h2>
                        <p className="text-sm text-slate-400 font-medium max-w-md">
                            Sécurisez votre compte en téléchargeant vos pièces justificatives lisibles.
                                    ...
                                    {doc.preview || (doc.url && doc.reviewStatus !== 'rejected') ? (
                                        ...
                                        <div className="flex gap-3">
                                            ...
                                            <button
                                                ...
                                                className="h-14 px-6 rounded-2xl bg-slate-900 text-white hover:bg-black transition-all flex items-center gap-3 font-bold text-sm shadow-xl shadow-slate-200"
                                            >
