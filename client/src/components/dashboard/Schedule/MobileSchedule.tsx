        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[50vh] text-center space-y-6 px-4">
                ...
                <div className="space-y-2">
                    <h2 className="text-xl font-bold text-gray-900">{t('noActiveLoan.title')}</h2>
                    <p className="text-sm text-gray-500">{t('noActiveLoan.message')}</p>
                </div>
                <button
                ...
                <div className="space-y-3">
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3 mb-3">
                            ...
                            <p className="text-[10px] font-bold text-white/60 uppercase tracking-widest">{t('stats.monthlyPayment')}</p>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        >
                            ...
                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">{t('stats.totalInterest')}</p>
                        ...
                        >
                            ...
                            <p className="text-[10px] font-bold text-white/60 uppercase tracking-widest mb-1">{t('stats.loanDuration')}</p>
                            <div className="flex items-baseline gap-1">
                                <p className="text-lg font-bold tracking-tight text-white">
                                    {schedule.length}
                                </p>
                                <span className="text-xs font-semibold text-white/60">{t('stats.months')}</span>
                            </div>
                        </motion.div>
                    </div>
                </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="flex items-center justify-between mb-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-bold text-slate-400 uppercase">{t('table.date')}</p>
                                        <p className="text-sm font-bold text-slate-900">{row.paymentDate}</p>
                                    </div>
                                </div>
                                <div className="text-right">
                                    <p className="text-[10px] font-bold text-slate-400 uppercase">{t('table.amount')}</p>
                            ...
                            <div className="grid grid-cols-2 gap-2 pt-3 border-t border-slate-50">
                                <div>
                                    <p className="text-[10px] text-slate-400 mb-0.5">{t('table.balance')}</p>
                                    <p className="text-xs font-bold text-emerald-600">{formatCurrency(row.remainingBalance)}</p>
                                </div>
                                <div className="text-right">
                                    <p className="text-[10px] text-slate-400 mb-0.5">{t('table.principal')}</p>
                                    <p className="text-xs font-bold text-slate-600">{formatCurrency(row.principal)}</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
