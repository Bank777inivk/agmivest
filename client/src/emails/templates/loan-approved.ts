...
export function loanApprovedTemplate(data: LoanApprovedData, lang: string = 'fr'): { subject: string; html: string } {
  const translations: Record<string, { subject: string; title: string; body: string; cta: string; info: string }> = {
    fr: {
      subject: "Approbation de votre demande — AGM INVEST",
    ...
    en: {
      subject: "Approval of your request — AGM INVEST",
    ...
    es: {
      subject: "Aprobacion de su solicitud — AGM INVEST",
    ...
    it: {
      subject: "Approvazione della tua richiesta — AGM INVEST",
    ...
    de: {
      subject: "Genehmigung Ihres Antrags — AGM INVEST",
    ...
    nl: {
      subject: "Goedkeuring van uw aanvraag — AGM INVEST",
    ...
    pl: {
      subject: "Zatwierdzenie Twojego wniosku — AGM INVEST",
    ...
    pt: {
      subject: "Aprovacao do seu pedido — AGM INVEST",
    ...
    ro: {
      subject: "Aprobarea cererii dumneavoastra — AGM INVEST",
    ...
    sv: {
      subject: "Godkannande av din ansokan — AGM INVEST",
