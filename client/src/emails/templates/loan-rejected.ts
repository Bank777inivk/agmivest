...
const translations: Record<string, { subject: string; title: string; body: string; cta: string; support: string }> = {
  fr: { subject: "📄 D&eacute;cision sur votre demande &mdash; AGM INVEST", title: "D&eacute;cision sur votre demande de pr&ecirc;t", body: "Apr&egrave;s examen attentif de votre dossier, nous ne sommes malheureusement pas en mesure d'accorder votre demande de financement pour le moment. Cette d&eacute;cision peut &ecirc;tre li&eacute;e &agrave; des crit&egrave;res d'&eacute;ligibilit&eacute; actuels. N'h&eacute;sitez pas &agrave; nous contacter pour en savoir plus.", cta: "Contacter le support", support: "Notre &eacute;quipe reste disponible pour vous accompagner." },
