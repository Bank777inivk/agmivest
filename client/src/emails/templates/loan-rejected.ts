...
export function loanRejectedTemplate(data: LoanRejectedData, lang: string = 'fr'): { subject: string; html: string } {
  const translations: Record<string, { subject: string; title: string; body: string; cta: string; support: string }> = {
    fr: {
      subject: "Information concernant votre dossier — AGM INVEST",
    ...
    en: {
      subject: "Information regarding your file — AGM INVEST",
    ...
    es: {
      subject: "Informacion sobre su expediente — AGM INVEST",
    ...
    it: {
      subject: "Informazioni sulla tua pratica — AGM INVEST",
    ...
    de: {
      subject: "Informationen zu Ihrer Akte — AGM INVEST",
    ...
    nl: {
      subject: "Informatie over uw dossier — AGM INVEST",
    ...
    pl: {
      subject: "Informacje o Twoim wniosku — AGM INVEST",
    ...
    pt: {
      subject: "Informacao sobre o seu processo — AGM INVEST",
    ...
    ro: {
      subject: "Informatii despre dosarul dumneavoastra — AGM INVEST",
    ...
    sv: {
      subject: "Information om din fil — AGM INVEST",
