...
const translations: Record<string, { subject: string; title: string; body: string; cta: string; support: string }> = {
  fr: { subject: "Mise a jour de votre dossier — AGM INVEST", title: "Bonjour", body: "Suite a l'etude de votre demande, nous vous informons que nous ne sommes pas en mesure d'y repondre favorablement pour le moment. Votre dossier a ete mis a jour avec les informations correspondantes.", cta: "Contacter le support", support: "Notre equipe reste disponible pour tout complement d'information via votre espace client." },
  ...
  nl: { subject: "Dossier bijwerking — AGM INVEST", title: "Hallo", body: "Na bestudering van uw aanvraag informeren wij u dat wij er op dit moment niet gunstig op kunnen reageren. Uw dossier is bijgewerkt med de bijbehorende informatie.", cta: "Contact opnemen", support: "Ons team blijft beschikbaar voor verdere informatie via uw klantengedeelte." },
