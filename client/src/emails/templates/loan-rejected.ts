...
const translations: Record<string, { subject: string; title: string; body: string; cta: string; support: string }> = {
  fr: { subject: "Mise a jour de votre dossier - AGM INVEST", title: "D&eacute;cision sur votre dossier", body: "Apr&egrave;s examen de votre dossier, nous ne sommes malheureusement pas en mesure de donner une suite favorable &agrave; votre demande pour le moment. Cette d&eacute;cision est bas&eacute;e sur nos crit&egrave;res internes actuels.", cta: "Contacter le support", support: "Notre &eacute;quipe reste disponible pour vous accompagner." },
