...
export function loanSubmittedTemplate(data: LoanSubmittedData, lang: string = 'fr'): { subject: string; html: string } {
  const translations: Record<string, { subject: string; title: string; body: string; cta: string; info: string }> = {
    fr: {
      subject: "Confirmation de votre demande — AGM INVEST",
    ...
    en: {
      subject: "Confirmation of your request — AGM INVEST",
    ...
    es: {
      subject: "Confirmacion de su solicitud — AGM INVEST",
    ...
    it: {
      subject: "Conferma della tua richiesta — AGM INVEST",
    ...
    de: {
      subject: "Bestatigung Ihres Antrags — AGM INVEST",
    ...
    nl: {
      subject: "Bevestiging van uw aanvraag — AGM INVEST",
    ...
    pl: {
      subject: "Potwierdzenie Twojego wniosku — AGM INVEST",
    ...
    pt: {
      subject: "Confirmacao do seu pedido — AGM INVEST",
    ...
    ro: {
      subject: "Confirmarea cererii dumneavoastra — AGM INVEST",
    ...
    sv: {
      subject: "Bekraftelse av din ansokan — AGM INVEST",
