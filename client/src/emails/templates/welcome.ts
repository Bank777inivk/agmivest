...
export function welcomeTemplate(data: WelcomeData, lang: string = 'fr'): { subject: string; html: string } {
    const translations: Record<string, { subject: string; title: string; body: string; cta: string; info: string }> = {
        ...
        es: {
            subject: "Confirmacion de apertura de cuenta — AGM INVEST",
        ...
        de: {
            subject: "Bestatigung der Kontoerofnung — AGM INVEST",
        ...
        pt: {
            subject: "Confirmacao de abertura de conta — AGM INVEST",
        ...
        sv: {
            subject: "Bekraftelse pa kontooppning — AGM INVEST",
