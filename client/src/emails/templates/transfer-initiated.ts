...
export function transferInitiatedTemplate(data: TransferInitiatedData, lang: string = 'fr'): { subject: string; html: string } {
    const translations: Record<string, { subject: string; title: string; body: string; cta: string; info: string }> = {
        ...
        en: {
            subject: "Transfer request recorded — AGM INVEST",
        ...
        es: {
            subject: "Solicitud de transferencia registrada — AGM INVEST",
        ...
        it: {
            subject: "Richiesta di trasferimento registrata — AGM INVEST",
        ...
        de: {
            subject: "Transferanfrage registriert — AGM INVEST",
        ...
        nl: {
            subject: "Overboekingsverzoek geregistreerd — AGM INVEST",
        ...
        pl: {
            subject: "Zlecenie przelewu zarejestrowane — AGM INVEST",
        ...
        pt: {
            subject: "Pedido de transferencia registado — AGM INVEST",
        ...
        ro: {
            subject: "Cerere de transfer inregistrata — AGM INVEST",
        ...
        sv: {
            subject: "Overforingsbegaran registrerad — AGM INVEST",
