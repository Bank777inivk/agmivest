...
export function kycRequiredTemplate(data: KycRequiredData, lang: string = 'fr'): { subject: string; html: string } {
  const translations: Record<string, { subject: string; title: string; body: string; cta: string }> = {
    fr: {
      subject: "Verification de votre identite — AGM INVEST",
    ...
    en: {
      subject: "Identity verification — AGM INVEST",
    ...
    es: {
      subject: "Verificacion de su identidad — AGM INVEST",
    ...
    it: {
      subject: "Verifica della tua identità — AGM INVEST",
    ...
    de: {
      subject: "Identitatsprufung — AGM INVEST",
    ...
    nl: {
      subject: "Identiteitsverificatie — AGM INVEST",
    ...
    pl: {
      subject: "Weryfikacja Twojej tozsamosci — AGM INVEST",
    ...
    pt: {
      subject: "Verificacao da sua identidade — AGM INVEST",
    ...
    ro: {
      subject: "Verificarea identitatii dumneavoastra — AGM INVEST",
    ...
    sv: {
      subject: "Identitetsverifiering — AGM INVEST",
