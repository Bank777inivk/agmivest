...
const kyc_approved: Record<string, { subject: string; title: string; body: string; cta: string }> = {
    fr: { subject: "Mise a jour de votre dossier - AGM INVEST", title: "Vos documents ont &eacute;t&eacute; examin&eacute;s", body: "Nous vous informons que l'examen de vos documents est termin&eacute;. Votre dossier suit son cours normalement.", cta: "Voir mon dossier" },
...
const kyc_rejected: Record<string, { subject: string; title: string; body: string; cta: string }> = {
    fr: { subject: "Mise a jour de votre dossier - AGM INVEST", title: "Action requise sur vos documents", body: "Certains documents transmis n'ont pas pu &ecirc;tre valid&eacute;s en l'&eacute;tat. Pourriez-vous nous les transmettre de nouveau ?", cta: "Envoyer les documents" },
    ...
    it: { subject: "Aggiornamento documenti — AGM INVEST", title: "I tuoi documenti non hanno potuto essere validati", body: "Purtroppo, i tuoi documenti di identità non hanno potuto essere accettati. Invia nuovi documenti conformi per continuare la tua pratica.", cta: "Invia i miei documenti" },
