...
export function kycApprovedTemplate(data: SimpleData, lang: string = 'fr'): { subject: string; html: string } {
    const translations: Record<string, { subject: string; title: string; body: string; cta: string }> = {
        fr: {
            subject: "Verification de documents validee — AGM INVEST",
        ...
        en: {
            subject: "Document verification validated — AGM INVEST",
        ...
        es: {
            subject: "Verificacion de documentos validada — AGM INVEST",
        ...
        it: {
            subject: "Verifica dei documenti convalidata — AGM INVEST",
        ...
        de: {
            subject: "Dokumentenprufung validiert — AGM INVEST",
        ...
        nl: {
            subject: "Documentverificatie gevalideerd — AGM INVEST",
        ...
        pl: {
            subject: "Weryfikacja dokumentow zatwierdzona — AGM INVEST",
        ...
        pt: {
            subject: "Verificacao de documentos validada — AGM INVEST",
        ...
        ro: {
            subject: "Verificarea documentelor validata — AGM INVEST",
        ...
        sv: {
            subject: "Dokumentverifiering validerad — AGM INVEST",
...
export function kycRejectedTemplate(data: SimpleData, lang: string = 'fr'): { subject: string; html: string } {
    const translations: Record<string, { subject: string; title: string; body: string; cta: string }> = {
        fr: {
            subject: "Action requise sur vos documents — AGM INVEST",
        ...
        en: {
            subject: "Action required on your documents — AGM INVEST",
        ...
        es: {
            subject: "Accion requerida en sus documentos — AGM INVEST",
        ...
        it: {
            subject: "Azione richiesta sui tuoi documenti — AGM INVEST",
        ...
        de: {
            subject: "Aktion fur Ihre Dokumente erforderlich — AGM INVEST",
        ...
        nl: {
            subject: "Actie vereist voor uw documenten — AGM INVEST",
        ...
        pl: {
            subject: "Wymagane dzialanie w dokumentach — AGM INVEST",
        ...
        pt: {
            subject: "Acao necessaria nos seus documentos — AGM INVEST",
        ...
        ro: {
            subject: "Actiune necesara pe documentele dumneavoastra — AGM INVEST",
        ...
        sv: {
            subject: "Atgard kravs for dina dokument — AGM INVEST",
